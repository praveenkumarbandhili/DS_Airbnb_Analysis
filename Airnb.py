...
icon = Image.open(r"C:\airnb\airnb icon.png")
st.set_page_config(page_title= "Airbnb Data Visualization | By B Praveen kumar",
                   page_icon= icon,
                   layout= "wide",
...
client = pymongo.MongoClient(r"mongodb+srv://bpraveen:looserchamp@cluster0.9wzmxio.mongodb.net/")
...
if selected == "Home":
    ...
    col2.markdown("#   ")
    col2.markdown("#   ")
    col2.image("C:\airnb\home_airnb.jpg")
# READING THE CLEANED DATAFRAME
df = pd.read_csv('Airbnb_data.csv')
